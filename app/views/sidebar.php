...
<aside id="sidebar" class="bg-[#0f172a] text-slate-300 flex flex-col transition-all duration-300 w-20 md:w-64 z-50 fixed md:relative h-full border-r border-slate-800/50 shadow-xl overflow-hidden group">
    ...
    <nav class="flex-1 overflow-y-auto py-6 flex flex-col gap-1.5 px-3 custom-scrollbar">
        ...
        <a href="?page=dashboard" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'dashboard' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-500/20' : 'hover:bg-slate-800 hover:text-white' ?>" title="Dashboard">
        ...
        <a href="?page=report_pl" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'report_pl' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-500/20' : 'hover:bg-slate-800 hover:text-white' ?>" title="Laporan Laba Rugi">
        ...
        <a href="?page=pos" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'pos' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-500/20' : 'hover:bg-slate-800 hover:text-white' ?>" title="Mesin Kasir (POS)">
        ...
        <div class="mt-4 mb-1 px-3">
            ...
            <a href="?page=menus" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'menus' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Master Menu POS">
            ...
            <a href="?page=products" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'products' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Master Bahan Baku">
            ...
            <a href="?page=categories" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'categories' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Master Kategori">
            ...
            <a href="?page=stocks" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'stocks' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Stok Masuk">
        ...
        <a href="?page=orders" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'orders' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Pesanan & Delivery">
        ...
        <a href="?page=transactions" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'transactions' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Riwayat Lunas">
        ...
        <a href="?page=receivables" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'receivables' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Piutang Berjalan">
        ...
        <a href="?page=closing" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'closing' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Tutup Buku">
        ...
        <a href="?page=expenses" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'expenses' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Pengeluaran (OPEX)">
        ...
        <div class="mt-4 mb-1 px-3">
            ...
            <a href="?page=settings" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'settings' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Pengaturan Toko">
            ...
            <a href="?page=users" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'users' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="Kelola Staf & Akses">
            ...
            <a href="?page=system_logs" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 <?= $page === 'system_logs' ? 'bg-slate-800 text-indigo-400' : 'hover:bg-slate-800 hover:text-white' ?>" title="System Logs">
